...
public class H28sePropertyFetcherTest {
	...
	@Test
	public void testSetPropertyImages() throws IOException {
		H28sePropertyFetcher propertyFetcher = new H28sePropertyFetcher();
		Document document = propertyFetcher
				.initConnection(
						"http://www.28hse.com/en/utf8/property112849.html")
				.execute().parse();
		List<String> links  = propertyFetcher.getPropertyImages(document);
		assertNotNull(links);
		assertTrue(!links.isEmpty());
	}
	@Test
	public void testSEtPropertyImagesEmptyArrayList() throws IOException{
		H28sePropertyFetcher propertyFetcher = new H28sePropertyFetcher();
		Document document = propertyFetcher
				.initConnection(
						"http://www.28hse.com/en/utf8/property108910.html")
				.execute().parse();
		List<String> links  = propertyFetcher.getPropertyImages(document);
		assertNotNull(links);
		assertTrue(links.isEmpty());
